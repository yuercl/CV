...
\section{教育经历}
\cventry{2010--至今}{通信工程专业}{\textsf{电子科技大学（985、211工程）}}{四川省成都市}
{工学学士}
{加权平均分3.07}
{}
%{主干课程：
...
\section{相关经验}
\subsection{项目经验}
\cventry{2012--至今}{网页前端，JavaEE}{\textsf{UESTC ACM-ICPC Online Judge}}{}{}{
	...
	\begin{description}
		...
		\item[\textsf{开发工具}] IntelliJ IDEA, MySQL workbench, chrome
...
\section{荣誉}
\subsection{ACM-ICPC}
\cvline{2013}{“中移电商杯”第38届ACM-ICPC亚洲区预选赛（长沙赛区）邀请赛 \textsf{金牌}}
...
\subsection{计算机技能}
\cvitem{\textsf{操作系统}}{linux(arch linux), OS X（主要）}
\cvitem{\textsf{版本控制}}{Subversion, Git}
\cvitem{\textsf{编程语言}}{C, C++, Java(Java EE), Javascript}
\cvitem{\textsf{开发工具}}{Vim, IntelliJ IDEA}
